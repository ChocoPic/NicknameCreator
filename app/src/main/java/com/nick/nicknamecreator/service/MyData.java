...
public class MyData {
    ...
    public final char[] KOR_ONE_LAST_CNT={1436, 3076, 410, 974, 615, 1333, 667, 615, 872};
    ...
    public final char[] FOR_ONE_TEXT = {'로', '오', '디', '루', '마', '리', '알', '일', '제', '엘', '드', '안', '이', '미', '아', '브', '노', '그', '레', '에', '클', '든', '비', '어', '벨', '린', '나', '바', '라', '슨', '카', '올', '스'};
    public final int[] FOR_ONE_CNT = {312, 312, 179, 223, 179, 1339, 134, 312, 134, 268, 134, 134, 714, 134, 1161, 179, 223, 134, 357, 223, 134, 134, 223, 223, 179, 179, 357, 179, 670, 179, 134, 179, 446};
